        ...
        <div id="header-image">
          ...
          <div className="header-title-container">
            {/*<img className="img-responsive" src="./images/DC_open House_sm-10.svg" alt="title" />*/}
             <a href="/"><img className="img-responsive" src="https://rawgit.com/CloudEntity57/DC-Open-House_List/master/client/public/images/DC_open%20House_sm-10.svg" alt="title" /></a>
